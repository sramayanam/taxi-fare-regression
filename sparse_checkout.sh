...
git_folder_location='/Users/sreeram/Documents/GitHub/taxi-fare-regression'   #replace with the local root folder location where you want to create the project folder
...
project_template_github_url=https://github.com/sramayanam/mlopsv2.git   #replace with the url for the project template for your organization created in step 2.2, or leave for demo purposes
